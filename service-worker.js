const CACHE='adaptive-exam-v0.3.0';
const ASSETS=['./','./index.html','./app.js','./data/sample-bank.js','./manifest.webmanifest','./icon.svg','./icon-192.png','./icon-512.png','./adrian-visual-system.js'];
